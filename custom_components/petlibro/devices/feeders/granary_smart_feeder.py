...
class GranarySmartFeeder(DryFoodFeeder):
    """Petlibro Granary Smart Feeder."""
    ...
    async def refresh(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception("Error refreshing data for GranarySmartFeeder")
    ...
    def remaining_desiccant(self) -> float | None:
        """Return the remaining desiccant."""
    ...
    def desiccant_frequency(self) -> float:
        """Return the desiccant frequency."""
