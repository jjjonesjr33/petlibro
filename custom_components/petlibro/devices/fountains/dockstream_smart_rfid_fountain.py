...
class DockstreamSmartRFIDFountain(Device):
    ...
    async def refresh(self) -> None:
        ...
        try:
            ...
            _LOGGER.exception("Error refreshing data for DockstreamSmartRFIDFountain")
    ...
    async def set_manual_cleaning(self) -> None:
